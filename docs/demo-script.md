...
Layers 1–4 can demonstrate architecture contracts, local
...
projection rebuild, and redacted ledger/timeline APIs. The demo cannot yet query
...
- **0–2:** Give the elevator pitch and state current Layer 4 limitations.
