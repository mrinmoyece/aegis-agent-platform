...
> deterministic timeline correlation. Live environments remain unverified;
> tools, memory, and agent reasoning remain planned.
...
| Hands-on labs (`labs.md`) | Turn each invariant into executable evidence and inject realistic failures | 1–9 | Layers 1–6 tests runnable |
