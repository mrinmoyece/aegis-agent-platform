...
REQUIRED_DOCUMENTS = {
    ...
    ROOT / "docs" / "adr" / "0016-hardened-ephemeral-sandbox-boundary.md",
    ROOT / "docs" / "adr" / "0017-event-grounded-memory-and-derived-rag.md",
    ROOT / "docs" / "adr" / "0018-layered-deterministic-evaluation-gates.md",
